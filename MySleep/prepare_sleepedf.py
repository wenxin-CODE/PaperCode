...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="/home/denglongyan/papercode/data/sleep-edf-database-expanded-1.0.0/sleep-cassette",
                        help="File path to the Sleep-EDF dataset.")
    parser.add_argument("--output_dir", type=str, default="/home/denglongyan/papercode/data/eeg_fpz_cz_78",
    ...
    for i in range(len(psg_fnames)):
        ...
        # print(psg_f.getStartdatetime(),ann_f.getStartdatetime())
        # print(type(psg_f.getStartdatetime()),ann_f.getStartdatetime())
        ...
        for s in range(psg_f.signals_in_file):
            if ch_names[s] == select_ch:
                ...
                break
        if select_ch_idx == -1:
            raise Exception(select_ch+"Channel not found.")
